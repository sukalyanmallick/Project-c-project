...
#include "../model/ai_engine.hpp"
#include "../view/ServerLogger.hpp"
...
public:
     ...
     */
    TcpServer(AiEngine& engine, View::ServerLogger* logger);
...
private:
    ...
    View::ServerLogger* logger_;          /* Injected View/Logger                  */
